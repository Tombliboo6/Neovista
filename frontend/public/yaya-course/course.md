...
文生视频的输入只有文字。课堂复现用完整提示词如下。

> 20世纪20年代的爵士俱乐部里，一名穿金色流苏裙的女舞者和一名穿条纹西装的男舞者表演高速查尔斯顿舞。两人完成快速切分步、空中抛接和大幅摆臂。镜头动态跟随，穿插脚步特写。金色流苏随踢腿剧烈摆动，皮肤带有汗水光泽，画面保留烟雾和复古胶片颗粒。背景出现爵士乐队与欢呼人群，形成热烈的派对气氛。

图生视频先输入一张图，再用文字规定接下来的动作。

![官方图生视频案例中晾衣女孩的输入画面](assets/examples/ai-video-i2v-input.jpg)

> 画面中的女孩优雅地晾好手中的衣服。她随后俯身从桶里拿出另一件衣服，双手展开并用力抖开，动作自然连贯。保持原图中的人物、红色长裙、阳台环境和夕阳光线一致。

官方发布页没有提供独立输入图下载，课件用官方成片首帧对应输入画面。

### 视频生视频 / 多模态生成

视频生视频案例使用骑马片段作为输入，再让模型续拍后面的动作。课堂复现用完整提示词如下。

> 延长参考视频。镜头继续跟拍骑棕马的橙衣男子，他加速奔向前方盛开橙色花朵的大树，折下两朵花。其他骑手依次进入画面。镜头推近，拍摄男子翻身下马，再快速环绕他一周。他走向骑白马的白衣女子，把花送给她。延续中国古典仕女画、三维动画与皮影结合的质感，主色为黑、白、橙，配乐使用轻快民乐。

多模态案例同时输入分镜表、人物图、场景图和道具图。课堂复现用完整提示词如下。

![官方多模态案例中的分镜表、人物、场景和道具四项输入素材](assets/examples/ai-video-multimodal-input.jpg)

> 按照参考图1的分镜脚本制作15秒治愈短片，沿用其中的镜头顺序、景别、运镜、画面内容和文案。主人公严格参考图2，场景严格参考图3，道具严格参考图4。保持角色外观、服装、环境光线与道具形态一致，镜头自然衔接，整体节奏舒缓。

### 多模态生成｜官方分镜表

![Seedance 2.0 官方演示视频开头展示的六镜分镜提示词表](assets/examples/ai-video-multimodal-storyboard-official.png)
...
| 年份 | 全球AI发展的关键节点 | 同一进程中的中国节点 |
|---|---|---|
| 1956 | 达特茅斯会议为人工智能命名，AI成为明确的研究领域 |  |
| 2012 | AlexNet推动视觉识别进入深度学习阶段 |  |
| 2017 | Transformer提出，注意力机制后来成为语言与多模态模型的重要基础 | 国务院发布《新一代人工智能发展规划》 |
| 2022 | ChatGPT让普通人开始直接用自然语言与生成式AI协作 |  |
| 2023 | 生成式AI产品快速进入日常工作与学习 | 文心一言、通义千问、讯飞星火、智谱清言和Kimi陆续面向普通用户 |
| 2024 | 文字生成视频进入更长镜头与复杂运动阶段 |  |
| 2025 | 推理模型、工具调用与智能体快速发展 | DeepSeek-R1以开放权重和技术报告发布 |
| 2026 | 文字、图片、声音、视频与工具进入连续工作流 | Seedance 2.0支持多模态视频生成与编辑 |

这条线索可以概括为：

**识别世界 → 生成内容 → 理解多种参考 → 连续完成任务**

## 全球AI发展的关键节点

![1955年达特茅斯人工智能研究计划书标题](assets/history/dartmouth-ai-proposal.webp)

![AlexNet团队成员与Geoffrey Hinton合影](assets/history/alexnet-team-2012.jpg)

![Attention Is All You Need论文中的Transformer结构图](assets/history/transformer-architecture-2017.png)

![OpenAI在2022年发布ChatGPT的官方页面](assets/history/chatgpt-launch-2022.png)

## 中国AI发展的关键节点

![国务院新一代人工智能发展规划官方页面](assets/history/china-ai-plan-2017.png)
...
![DeepSeek-R1官方发布页中的能力评测图](assets/history/deepseek-r1-benchmark.png)

![字节跳动Seedance 2.0官方发布页面](assets/history/seedance-2-launch-2026.png)
...
下一阶段将继续建设年度选题库。点击查看完整执行方案中的[阶段选题库 31 条候选方向截图](assets/project/topic-bank-31-plan.png)，作为年度内容建设的现有基础。
...
![Prism造物所账号在2026年7月24日的主页数据](assets/cases/prism-account-20260724.png)

团队自营账号“Prism造物所”从 2026 年 7 月 1 日开始运营，到 7 月 24 日由 0 增长至 4475 名粉丝，累计获得约 2.5 万次获赞与收藏。视频内容本身并不复杂，增长更依赖热点观察、选题判断、持续测试和数据复盘。

AI降低的是视频制作的启动门槛；一个账号能否持续增长，仍然取决于人的内容判断。学会AI视频，也是在为经营自己的自媒体账号和个人IP增加一种更高效的生产方式。

## 分组

![饭团、小小和馒头示范发现、倾听与推进三类协作动作](assets/generated/duck-team-roles-v1.jpg)

现有问卷共 11 份，其中 1 份为老师信息，不纳入学生分组。其余 10 名学生根据问卷里的项目经验、影视经历、AI 操作程度和参与方向，先进行能力互补式分组；尚未填写问卷的 2 名学生补充信息后，分别加入 B 组和 C 组。后续可根据课堂观察调整。

| 小组 | 人数 | 学生名单 |
|---|---|---|
| A 组 | 4 人 | 杨蕊羽、卢秋江、汪蕊、桑学涵 |
| B 组 | 3 人＋待补充 1 人 | 李国豪、杨瑞盈、买尔哈巴·买买提 |
| C 组 | 3 人＋待补充 1 人 | 袁纤惠、蒋欣益、达珂遥 |
